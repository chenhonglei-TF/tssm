...
public class MyBootStrap {
     ...
     * @param assetpath
     */
    public MyBootStrap(String webxmlpath, String assetpath) {
        this(-1,webxmlpath,assetpath);
    }

    public MyBootStrap(int port, String webxmlpath, String contextDir) {
        if(port>0){
            this.port = port;
        }
    ...
    public static void main(String[] args) {
        MyBootStrap myBootStrap = new MyBootStrap("classpath:web.xml","projectpath:static");
        //服务开启
        myBootStrap.start();
    }
}
